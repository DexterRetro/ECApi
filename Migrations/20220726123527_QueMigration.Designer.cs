...
namespace ECApi.Migrations
{
    ...
    [Migration("20220726123527_QueMigration")]
    partial class QueMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECApi.Models.Itemimages", b =>
                {
                    b.HasOne("ECApi.Models.MusikaItem", "MusikaItem")
                        .WithMany("ItemImages")
                        .HasForeignKey("MusikaItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MusikaItem");
                });
            ...
            modelBuilder.Entity("ECApi.Models.ItemQue", b =>
                {
                    ...
                    b.HasOne("ECApi.Models.MusikaUser", "MusikaUser")
                        .WithMany("ItemQue")
